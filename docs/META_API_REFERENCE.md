...
- Solicitar somente `instagram_business_basic`, `instagram_business_content_publish` e `instagram_business_manage_insights`.
...
| Escopos | [Business Login](https://developers.facebook.com/docs/instagram-platform/instagram-api-with-instagram-login/business-login), [Permissions reference](https://developers.facebook.com/docs/permissions#instagram_business_basic), [Postman oficial](https://www.postman.com/meta/instagram/documentation/6yqw8pt/instagram-api) | 01/09/2026 | `instagram_business_basic` lê perfil/mídia básica. `instagram_business_content_publish` depende do primeiro e permite publicação orgânica. `instagram_business_manage_insights` habilita os endpoints de insights de conta e mídia. Os nomes antigos `business_basic` e `business_content_publish` foram descontinuados em 27/01/2025. | OAuth pede os três escopos. Rejeitar conexão só se `instagram_business_basic` ou `instagram_business_content_publish` não for concedido; `instagram_business_manage_insights` é opcional (análises ficam desabilitadas sem ele). Não pedir mensagens, comentários ou ads. |
